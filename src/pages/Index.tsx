...
const PRICE: { group: string; items: { name: string; price: string }[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Окрашивание в один тон', price: 'от 2 800 ₽' },
      { name: 'Сложное окрашивание', price: 'от 6 000 ₽' },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      { name: 'Наращивание ресниц', price: 'от 2 200 ₽' },
      { name: 'Ламинирование ресниц', price: 'от 1 800 ₽' },
      { name: 'Коррекция и окрашивание бровей', price: 'от 1 000 ₽' },
    ],
  },
  {
    group: 'Перманентный макияж',
    items: [
      { name: 'Перманент бровей', price: 'от 6 000 ₽' },
      { name: 'Перманент губ', price: 'от 7 000 ₽' },
    ],
  },
  {
    group: 'Тело',
